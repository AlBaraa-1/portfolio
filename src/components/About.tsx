...
const About: React.FC = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="min-h-screen flex items-center justify-center py-10 sm:py-20">
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="code-block w-full max-w-3xl mx-auto overflow-hidden">
