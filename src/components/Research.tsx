...
const Research: React.FC = () => {
  ...
  return (
    <section id="research" ref={sectionRef} className="py-12 sm:py-16 md:py-20">
          ...
          {research.map((paper, index) => (
            ...
            >
              ...
              <div className="p-4 sm:p-6 md:p-8 lg:p-12">
                {/* Trophy Badge */}
                <div>
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full animate-glow mb-3 sm:mb-4"
                       style={{ backgroundColor: 'var(--accent)', color: 'var(--bg-primary)' }}>
                    <Trophy className="w-4 sm:w-5 h-4 sm:h-5 animate-bounce-slow" />
                    <span className="text-sm sm:text-base font-bold whitespace-nowrap">Published {paper.year}</span>
                  </div>
                </div>
                <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 items-start lg:items-center">
                  {/* Paper Content */}
                  <div className="lg:col-span-2">
                    <div className="mb-3 sm:mb-4">
                      <span className="inline-block px-2.5 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold mb-3 sm:mb-4"
                            style={{ 
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 sm:gap-3 w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold text-base sm:text-lg border-2 transition-all duration-300 hover:scale-105 active:scale-95"
                      style={{ 
